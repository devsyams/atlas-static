...
export const DANANTARA_ACTORS: MediaActor[] = [
  ...
  // DEMO bot #2 (placeholder) — no avatarUrl, so the card falls back to initials.
  // Swap for a real flagged account when live authenticity data lands.
  { handle: "kawal_bumn", name: "Kawal BUMN", platform: "X", type: "influencer", reach: 132_000, influence: 5.0, credibility: 2.8, stance: "negative", posts_7d: 71, mentions: 148, drives: ["tata-kelola", "investasi", "kebijakan", "pasar", "sosial"], verified: false, bot: true, note: "Akun anonim ber-volume tinggi; pola unggah terjadwal menandai amplifikasi terkoordinasi." },
