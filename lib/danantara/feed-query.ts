 ...
 * `days` (the A7 v49.0 selected topics window), and `bgn` (the A13 v6.3 BGN-product
 ...
 */
export function feedQuery(opts: { fresh?: boolean; mock?: boolean; days?: number; bgn?: boolean }): string {
