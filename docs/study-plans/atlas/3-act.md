...
- **Version:** 5.2 · **Stage:** 3-act · **Sprint:** demo · **Status:** Built · **Spec ref:** built on A7's Danantara topics feed + the OpenGate `/threats` + `/actor-intelligence` feeds; CEO feedback 2026-06-22 · **Owner:** Dev A
