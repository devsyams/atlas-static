...
- **Version:** 1.1 · **Stage:** 3-act · **Sprint:** demo · **Status:** In progress · **Spec ref:** `docs/superpowers/specs/2026-08-01-board-level-threat-index-response-simulator.md` · **Owner:** Dev A
...
- **AC9** — *Given* the board simulator, *When* it renders, *Then* it shows the Threat Index, the mapped multiplier, the deployed total, the KOL / clipper / grassroots split, and the modeled post-response Threat Index; the old share-of-voice bar is no longer present.
...
| T6 | AC2 | `crisisIndex` → multiplier is monotonic / banded as documented; lower threat never yields a higher response multiplier than a higher threat | pure |
...
| T27 | AC9 | the board simulator renders the Threat Index, multiplier, deploy total and channel split; the old SOV bar is absent | component |
